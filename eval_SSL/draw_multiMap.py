...
if __name__ == "__main__":
    ...
    print("----- defect -----")
    if args.resume and os.path.isfile('{}/Results/testing_multiMap/ssl/{}/all/128_img_all_feature_{}_Origin.pickle'.format(ROOT, args.data, args.index)):
        print("load from {}/Results/testing_multiMap/ssl/{}/all/128_img_all_feature_{}_Origin.pickle".format(ROOT, args.data, args.index))
        img_all_feature = pickle.load(open('{}/Results/testing_multiMap/ssl/{}/all/128_img_all_feature_{}_Origin.pickle'.format(ROOT, args.data, args.index), 'rb'))
    else:
        img_all_feature = eval_feature(pretrain_model, scratch_model, test_all_loader, kmeans, pca, args.data, global_index, good=False)

    print("----- good -----")
    if args.resume and os.path.isfile('{}/Results/testing_multiMap/ssl/{}/good/128_img_good_feature_{}_Origin.pickle'.format(ROOT, args.data, args.index)):
        print("load from {}/Results/testing_multiMap/ssl/{}/good/128_img_good_feature_{}_Origin.pickle".format(ROOT, args.data, args.index))
        img_good_feature = pickle.load(open('{}/Results/testing_multiMap/ssl/{}/good/128_img_good_feature_{}_Origin.pickle'.format(ROOT, args.data, args.index), 'rb'))
    else:
    ...
    for ((idx, img), (idx2, img2)) in zip(test_all_loader, mask_loader):
        ...
        errorMapPath = "{}/Results/testing_multiMap/ssl/{}/all/{}/map/".format(ROOT, test_data, args.kmeans)
    ...
    for (idx, img) in test_good_loader:
        ...
        errorMapPath = "{}/Results/testing_multiMap/ssl/{}/good/{}/map/".format(ROOT, test_data, args.kmeans)
        if not os.path.isdir(errorMapPath):
            os.makedirs(errorMapPath)

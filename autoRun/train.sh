#!/bin/bash
CUDA_VISIBLE_DEVICES=2,3 python model_feature_first_weightSample.py --image_size 224 --patch_size 32 --train_batch 8 --test_batch_size 7 --dim 128 --kmeans=64 --data=cable --with_mask True --dim_reduction PCA --type=good --epoch 60 --fine_tune_epoch 300 &
wait

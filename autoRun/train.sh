#!/bin/bash
CUDA_VISIBLE_DEVICES=2,3 python model_weightSample_SSL.py --image_size 256 --patch_size 16 --train_batch 16 --test_batch_size 16 --dim 128 --kmeans=128 --data=bottle --with_mask True --dim_reduction PCA --type=good --epoch 60
wait

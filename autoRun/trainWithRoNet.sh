CUDA_VISIBLE_DEVICES=0,1 python model_Artificial_weightSample.py --data bottle --kmeans 128 --type good --train_batch 16 --with_mask True --patch_size 64 --epoch 40 &
...
CUDA_VISIBLE_DEVICES=2,3 python model_Artificial_weightSample.py --data carpet --kmeans 128 --type good --train_batch 16 --with_mask True --patch_size 64 --epoch 40 &
wait
...
# wait
# CUDA_VISIBLE_DEVICES=2,3 python model_Artificial_weightSample.py --data screw --kmeans 128 --type good --train_batch 16 --with_mask True --patch_size 64 --epoch 40 &
# CUDA_VISIBLE_DEVICES=2,3 python model_Artificial_weightSample.py --data toothbrush --kmeans 128 --type good --train_batch 16 --with_mask True --patch_size 64 --epoch 40 &
# wait
# CUDA_VISIBLE_DEVICES=0,1 python model_Artificial_weightSample.py --data transistor --kmeans 128 --type good --train_batch 16 --with_mask True --patch_size 64 --epoch 40 &
# CUDA_VISIBLE_DEVICES=2,3 python model_Artificial_weightSample.py --data wood --kmeans 128 --type good --train_batch 16 --with_mask True --patch_size 64 --epoch 40 &
# wait
# CUDA_VISIBLE_DEVICES=0,1 python model_Artificial_weightSample.py --data zipper --kmeans 128 --type good --train_batch 16 --with_mask True --patch_size 64 --epoch 40 &
# wait

...
# CUDA_VISIBLE_DEVICES=0 python preprocess/pretrain_vgg.py --dim_reduction UMAP --data bottle --patch_size 64 &
# CUDA_VISIBLE_DEVICES=1 python preprocess/pretrain_vgg.py --dim_reduction UMAP --data cable --patch_size 64 &
# CUDA_VISIBLE_DEVICES=2 python preprocess/pretrain_vgg.py --dim_reduction UMAP --data capsule --patch_size 64 &
# CUDA_VISIBLE_DEVICES=3 python preprocess/pretrain_vgg.py --dim_reduction UMAP --data carpet --patch_size 64 &
# wait
# CUDA_VISIBLE_DEVICES=0 python preprocess/pretrain_vgg.py --dim_reduction UMAP --data grid --patch_size 64 &
# CUDA_VISIBLE_DEVICES=1 python preprocess/pretrain_vgg.py --dim_reduction UMAP --data hazelnut --patch_size 64 &
# CUDA_VISIBLE_DEVICES=2 python preprocess/pretrain_vgg.py --dim_reduction UMAP --data leather --patch_size 64 &
# CUDA_VISIBLE_DEVICES=3 python preprocess/pretrain_vgg.py --dim_reduction UMAP --data metal_nut --patch_size 64 &
# wait
# CUDA_VISIBLE_DEVICES=0 python preprocess/pretrain_vgg.py --dim_reduction UMAP --data pill --patch_size 64 &
# CUDA_VISIBLE_DEVICES=1 python preprocess/pretrain_vgg.py --dim_reduction UMAP --data screw --patch_size 64 &
# CUDA_VISIBLE_DEVICES=2 python preprocess/pretrain_vgg.py --dim_reduction UMAP --data tile --patch_size 64 &
# CUDA_VISIBLE_DEVICES=3 python preprocess/pretrain_vgg.py --dim_reduction UMAP --data toothbrush --patch_size 64 &
# wait
# CUDA_VISIBLE_DEVICES=0 python preprocess/pretrain_vgg.py --dim_reduction UMAP --data transistor --patch_size 64 &
# CUDA_VISIBLE_DEVICES=1 python preprocess/pretrain_vgg.py --dim_reduction UMAP --data wood --patch_size 64 &
# CUDA_VISIBLE_DEVICES=2 python preprocess/pretrain_vgg.py --dim_reduction UMAP --data zipper --patch_size 64 &
# # wait

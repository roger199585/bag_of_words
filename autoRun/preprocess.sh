...
# CUDA_VISIBLE_DEVICES=0 python preprocess/pretrain_vgg.py --dim_reduction PCA --data bottle --patch_size 64 &
...
# CUDA_VISIBLE_DEVICES=2 python preprocess/pretrain_vgg.py --dim_reduction PCA --data tile --patch_size 64 &
...
# 給定每個 patch 的 label
# CUDA_VISIBLE_DEVICES=1 python preprocess/assign_idx.py --dim_reduction PCA --patch_size 64 --data bottle --dim 128 --kmeans 128 --type train &
# CUDA_VISIBLE_DEVICES=1 python preprocess/assign_idx.py --dim_reduction PCA --patch_size 64 --data bottle --dim 128 --kmeans 128 --type test &
# CUDA_VISIBLE_DEVICES=1 python preprocess/assign_idx.py --dim_reduction PCA --patch_size 64 --data bottle --dim 128 --kmeans 128 --type all &
...
# CUDA_VISIBLE_DEVICES=2 python preprocess/assign_idx.py --dim_reduction PCA --patch_size 64 --data tile --dim 128 --kmeans 128 --type train &
# CUDA_VISIBLE_DEVICES=2 python preprocess/assign_idx.py --dim_reduction PCA --patch_size 64 --data tile --dim 128 --kmeans 128 --type test &
# CUDA_VISIBLE_DEVICES=2 python preprocess/assign_idx.py --dim_reduction PCA --patch_size 64 --data tile --dim 128 --kmeans 128 --type all &

...
# # 給定每個 patch 的 label
CUDA_VISIBLE_DEVICES=0 python preprocess_feature_first/assign_idx.py --dim_reduction PCA --data bottle --dim 128 --kmeans 128 --type train &
CUDA_VISIBLE_DEVICES=0 python preprocess_feature_first/assign_idx.py --dim_reduction PCA --data bottle --dim 128 --kmeans 128 --type test &
CUDA_VISIBLE_DEVICES=1 python preprocess_feature_first/assign_idx.py --dim_reduction PCA --data bottle --dim 128 --kmeans 128 --type all &
CUDA_VISIBLE_DEVICES=1 python preprocess_feature_first/assign_idx.py --dim_reduction PCA --data cable --dim 128 --kmeans 128 --type train &
CUDA_VISIBLE_DEVICES=2 python preprocess_feature_first/assign_idx.py --dim_reduction PCA --data cable --dim 128 --kmeans 128 --type test &
CUDA_VISIBLE_DEVICES=2 python preprocess_feature_first/assign_idx.py --dim_reduction PCA --data cable --dim 128 --kmeans 128 --type all &
...
# 我不知道這邊在幹嘛 我就爛
python dataloaders.py --dim_reduction PCA --image_size 1024 --patch_size 64 --data bottle --kmeans 128 &
python dataloaders.py --dim_reduction PCA --image_size 1024 --patch_size 64 --data cable --kmeans 128 &
...
python preprocess_feature_first/getCenterFeature.py --dim_reduction PCA --image_size 1024 --patch_size 64 --data bottle --kmeans 128 &
python preprocess_feature_first/getCenterFeature.py --dim_reduction PCA --image_size 1024 --patch_size 64 --data cable --kmeans 128 &

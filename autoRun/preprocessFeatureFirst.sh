...
# python preprocess/preprocess.py --root $PWD -s 224 --types bottle_3  &
...
# 建立 chunks
CUDA_VISIBLE_DEVICES=0 python preprocess_feature_first/pretrain_vgg.py --data bottle_3 --image_size 224 --patch_size 32 --fine_tune_epoch 10 &
...
python preprocess_feature_first/BoW_PCA.py --data bottle_3 --kmeans 128 --dim 128 --dim_reduction PCA &
...
# # 給定每個 patch 的 label
CUDA_VISIBLE_DEVICES=2 python preprocess_feature_first/assign_idx.py --dim_reduction PCA --data bottle_3 --dim 128 --kmeans 128 --type train --fine_tune_epoch 10 &
CUDA_VISIBLE_DEVICES=2 python preprocess_feature_first/assign_idx.py --dim_reduction PCA --data bottle_3 --dim 128 --kmeans 128 --type test --fine_tune_epoch 10 &
wait
CUDA_VISIBLE_DEVICES=3 python preprocess_feature_first/assign_idx.py --dim_reduction PCA --data bottle_3 --dim 128 --kmeans 128 --type all --fine_tune_epoch 10 &
...
# 我不知道這邊在幹嘛 我就爛
python dataloaders.py --dim_reduction PCA --image_size 224 --patch_size 32 --data bottle_3 --kmeans 128 &
...
python preprocess_feature_first/getCenterFeature.py --dim_reduction PCA --image_size 224 --patch_size 32 --data bottle_3 --kmeans 128 &

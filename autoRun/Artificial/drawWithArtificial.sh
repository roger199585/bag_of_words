...
# Single Map
CUDA_VISIBLE_DEVICES=2,3 python evalArtificial/eval_aucroc.py --patch_size 64 --kmeans 128 --data leather --index 39 &

# Multi Map
CUDA_VISIBLE_DEVICES=0,1 python evalArtificial/multi_map.py --patch_size 64 --kmeans 128 --data leather --index 39 &
wait
# draw Multi Map
CUDA_VISIBLE_DEVICES=2,3 python evalArtificial/draw_multiMap.py --patch_size 64 --kmeans 128 --data leather --index 39

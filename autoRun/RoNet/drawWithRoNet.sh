...
# # Single Map
CUDA_VISIBLE_DEVICES=0,1 python evalRoNet/eval_aucroc.py --patch_size 64 --kmeans 128 --data bottle --index 30 &
CUDA_VISIBLE_DEVICES=2,3 python evalRoNet/eval_aucroc.py --patch_size 64 --kmeans 128 --data cable --index 30 &
# wait
...
# # Multi Map
CUDA_VISIBLE_DEVICES=0,1 python evalRoNet/multi_map.py --patch_size 64 --kmeans 128 --data bottle --index 30 &
CUDA_VISIBLE_DEVICES=2,3 python evalRoNet/multi_map.py --patch_size 64 --kmeans 128 --data cable --index 30 &
# wait
...
# # draw Multi Map
CUDA_VISIBLE_DEVICES=0,1 python evalRoNet/draw_multiMap.py --patch_size 64 --kmeans 128 --data bottle --index 30 &
CUDA_VISIBLE_DEVICES=2,3 python evalRoNet/draw_multiMap.py --patch_size 64 --kmeans 128 --data cable --index 30 &
# wait
...
# # Single Map
# CUDA_VISIBLE_DEVICES=0,1 python evalRoNet/eval_aucroc.py --patch_size 64 --kmeans 128 --data capsule --index 33 &
# CUDA_VISIBLE_DEVICES=2,3 python evalRoNet/eval_aucroc.py --patch_size 64 --kmeans 128 --data hazelnut --index 23 &
# wait

# # Multi Map
# CUDA_VISIBLE_DEVICES=0,1 python evalRoNet/multi_map.py --patch_size 64 --kmeans 128 --data capsule --index 33 &
# CUDA_VISIBLE_DEVICES=2,3 python evalRoNet/multi_map.py --patch_size 64 --kmeans 128 --data hazelnut --index 23 &
# wait

# # draw Multi Map
# CUDA_VISIBLE_DEVICES=0,1 python evalRoNet/draw_multiMap.py --patch_size 64 --kmeans 128 --data capsule --index 33 &
# CUDA_VISIBLE_DEVICES=2,3 python evalRoNet/draw_multiMap.py --patch_size 64 --kmeans 128 --data hazelnut --index 23 &
# wait

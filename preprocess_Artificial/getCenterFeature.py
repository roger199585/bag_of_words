...
if __name__ == "__main__":
    ...
    train_label_name     = f"{ ROOT }/preprocessData/label/artificial/{ args.data }/train/{ args.kmeans }.pth"
    train_label          = torch.tensor(torch.load(train_label_name))

    origin_features_path = f"{ ROOT }/preprocessData/chunks/artificial/{ args.data }/chunks_{ args.data }_train.pickle".format(ROOT, args.data)
    ...
    save_path = f"{ ROOT }/preprocessData/cluster_center/artificial/{ args.data }/"

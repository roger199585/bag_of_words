...
if __name__ == "__main__":
    ...
    if args.type == 'train':
        ...
        if not os.path.isdir( f"{ ROOT }/preprocessData/label/ssl/{ args.dim_reduction }/{ args.data }/train/" ):
            os.makedirs( f"{ ROOT }/preprocessData/label/ssl/{ args.dim_reduction }/{ args.data }/train/" )

    elif args.type == 'test':
        path      = f"{ ROOT }/dataset/{ args.data }/test_resize/good/"
        save_path = f"{ ROOT }/preprocessData/label/ssl/{ args.dim_reduction }/{ args.data }/test/good_{ str(args.kmeans) }_{ str(args.batch) }.pth"
        
        if not os.path.isdir( f"{ ROOT }/preprocessData/label/ssl/{ args.dim_reduction }/{ args.data }/test/"):
            os.makedirs( f"{ ROOT }/preprocessData/label/ssl/{ args.dim_reduction }/{ args.data }/test/")
            
    elif args.type == 'all':
        path      = f"{ ROOT }/dataset/{ args.data }/test_resize/all/"
        save_path = f"{ ROOT }/preprocessData/label/ssl/{ args.dim_reduction }/{ args.data }/test/all_{ str(args.kmeans) }_{ str(args.batch) }.pth"
